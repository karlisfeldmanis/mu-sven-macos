...
const MUEnvironmentScript = preload("res://addons/mu_tools/world/environment_node.gd")
...
func apply_character_shader(material: ShaderMaterial, texture: Texture2D):
	material.shader = preload("res://addons/mu_tools/shaders/mu_character.gdshader")
