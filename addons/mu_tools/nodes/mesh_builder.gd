...
static func build_mesh(bmd_mesh: BMDParser.BMDMesh, 
	...
	# Cyclic permutation (det=+1): MU CW winding preserved, reverse to Godot CCW.
...
static func create_mesh_instance_v2(bmd_mesh: BMDParser.BMDMesh, 
		skeleton: Skeleton3D = null, 
		path: String = "",
		parser: BMDParser = null,
		bake_pose: bool = false,
...
static func build_mesh_v2(bmd_mesh: BMDParser.BMDMesh, 
		_skeleton: Skeleton3D = null, 
		bmd_path: String = "",
		_parser: BMDParser = null,
		bake_pose: bool = false,
